          ...
          {programs.map((program, index) => {
            ...
            return (
              <motion.a
                ...
                className="group flex flex-col items-start rounded-2xl border border-slate-200 bg-white p-6 text-left shadow-sm transition-all duration-200 hover:-translate-y-1 hover:border-[#0a2a5e]/20 hover:shadow-lg hover:shadow-slate-900/10"
              >
