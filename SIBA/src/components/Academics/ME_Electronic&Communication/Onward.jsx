...
const courseGroups = [
  {
    title: "Core Courses",
    subtitle: "ME Electronics and Communication",
    courses: [
      ["01", "EE-701", "Advanced Control Systems", three],
      ["02", "EE-708", "Advanced Digital Signal Processing", three],
  ...
  },
  {
    ...
    subtitle: "ME Electronics and Communication",
    courses: [
      ["07", "EE-736", "Advanced Digital Systems Design", three],
      ["08", "EE-739", "Advanced Communication Networks", three],
      ["09", "EE-540", "Advanced Integrated Circuits", three],
      ["08", "EE-710", "Advanced Radio Frequency Circuit Design", three],
    ],
  },
  {
    ...
    subtitle: "ME Electronics and Communication",
    courses: [
      ["9", "EE-741", "Advanced Satellite Communication", three],
      ["10", "EE-742", "Advanced Nano Technologies", three],
    ],
  },
];
...
const semesters = [
  ...
  },
  {
    ...
    courses: [
      ["04", "", "Core-III", three],
      ["05", "", "Elective-II", three],
      ["06", "", "Elective-III", three],
      ["06", "", "Tafheem Ul Quran-II", one],
    ],
    total: "10(09+1)",
  },
  {
    ...
    courses: [
      ["07", "", "Core-IV", three],
      ["08", "", "Elective-IV", three],
      ["09", "", "Thesis-l/Elective-V", three],
    ],
    total: "09(09+0)",
  },
  {
    ...
    <main className="bg-slate-50 text-slate-700">
      <section className="relative overflow-hidden bg-[#071f47] text-white">
        ...
        <div className="relative mx-auto max-w-[1440px] px-5 py-16 sm:px-6 lg:px-10 lg:py-20">
          <Reveal className="max-w-4xl">
            <p className="text-xs font-semibold uppercase tracking-[0.24em] text-amber-300">M.E. Electronics and Communication</p>
            <h1 className="mt-4 font-serif text-4xl font-bold leading-tight sm:text-5xl lg:text-6xl">Course schema</h1>
            <p className="mt-6 max-w-2xl text-base leading-8 text-blue-100/80 sm:text-lg">Course Schema of M.E. (Electronics and Communication) - From Batch 2025 and onwards</p>
          </Reveal>
        </div>
      </section>

      <section className="mx-auto max-w-[1440px] px-5 py-14 sm:px-6 lg:px-10 lg:py-20">
        <SectionHeading eyebrow="From Batch 2025 and onwards" title="Course Distribution into categories" />
      ...
      <section className="mx-auto max-w-[1440px] px-5 py-14 sm:px-6 lg:px-10 lg:py-20">
        ...
        <Reveal className="mt-8 flex flex-wrap items-center justify-between gap-3 border border-slate-200 bg-[#071f47] px-5 py-4 text-white shadow-sm">
          <span className="font-serif text-xl font-bold">Grand Total Credit Hours</span>
      ...
      <section className="border-t border-slate-200 bg-[#e9eff5]">
        <div className="mx-auto max-w-[1440px] px-5 py-14 sm:px-6 lg:px-10 lg:py-20">
          <SectionHeading eyebrow="Course pool" title="List of all courses" />
          <Reveal className="mt-10 overflow-hidden border border-slate-200 bg-white shadow-sm">
            <div className="border-b border-slate-200 bg-[#071f47] px-5 py-4 text-white">
              <h3 className="font-serif text-xl font-bold">Other elective courses:</h3>
              <p className="mt-1 text-xs text-blue-100/75">ME Electronics and Communication</p>
            </div>
            <CourseTable courses={otherElectives} />
          </Reveal>
