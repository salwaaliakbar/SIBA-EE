...
const courseGroups = [
  {
    title: "Core Courses",
    subtitle:
      "ME Electrical Engineering with specialization in (i) Power Systems, and (ii) Electronic Systems",
    courses: [
  ...
  },
  {
    ...
    subtitle: "ME Electrical Engineering with specialization in Power Systems",
    courses: [
  ...
  {
    title: "Elective Courses",
    subtitle: "ME Electrical Engineering with specialization in Electronic Systems",
    courses: [
  ...
  {
    title: "Additional Elective Courses",
    subtitle: "ME Electrical Engineering with specialization in Electronic Systerns",
    courses: [
...
const semesters = [
  ...
  },
  {
    ...
    courses: [
      ["07", "", "Core-III", "3(3+0)"],
      ["08", "", "Core-IV", "3(3+0)"],
      ["09", "", "Thesis-l/Elective-V", "3(3+0)"],
    ],
    total: "09(09+0)",
  },
  {
    title: "Fourth Semester",
    courses: [["10", "", "Thesis-II I/Elective-VI", "3(3+0)"]],
    total: "09(09+0)",
  },
];
...
const otherElectives = [
  ...
  ["14", "EE-529", "Advance Power System Protection"],
...
function CourseTable({ courses, showNumber = true, total }) {
  return (
        ...
        {total && (
          <tfoot>
            <tr className="border-t border-slate-200 bg-slate-50 font-semibold text-[#071f47]">
              <td className="px-5 py-4" colSpan={showNumber ? 3 : 2}>Total Credit Hours</td>
  ...
  return (
    <main className="bg-slate-50 text-slate-700">
      ...
      <section className="mx-auto max-w-[1440px] px-5 py-14 sm:px-6 lg:px-10 lg:py-20">
        ...
        <div className="mt-10 space-y-8">
          {semesters.map((semester, index) => <Reveal key={semester.title} delay={(index % 2) * 0.06} className="overflow-hidden border border-slate-200 bg-white shadow-sm"><div className="flex items-center justify-between gap-3 border-b border-slate-200 bg-[#071f47] px-5 py-4 text-white"><h3 className="font-serif text-2xl font-bold">{semester.title}</h3><span className="font-mono text-xs uppercase tracking-wider text-amber-300">Total Credit Hours: {semester.total}</span></div><CourseTable courses={semester.courses} total={semester.total} /></Reveal>)}
        </div>
